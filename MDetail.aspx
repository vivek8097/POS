<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MDetail.aspx.cs" MasterPageFile="~/mpos.master" Inherits="Detail" %>
        ...
        <InsertItemTemplate>
         ...
         <asp:Image ID="Image1" runat="server" ImageUrl='<%#Eval("image")%>' Width="230" Height="230" BorderStyle="Groove" ImageAlign="AbsMiddle" />           
            <br /><p></p>
                 ...
                 <b style="font-size: medium">नाव:</b>
            <asp:Label ID="nameLabel" runat="server" Text='<%# Bind("name") %>' />
            <br />
           <b style="font-size: medium">जन्मदिनांक:</b>
            <asp:Label ID="dobLabel" runat="server" Text='<%# Bind("dob") %>' />
            <br />
           <b style="font-size: medium">जन्मस्थळ:</b>
            <asp:Label ID="addressLabel" runat="server" Text='<%# Bind("address") %>' />
            <br />
            <b style="font-size: medium">व्यक्तिमत्व वर्ग:</b>
            <asp:Label ID="fieldsLabel" runat="server" Text='<%# Bind("fields") %>' />
            <br />
            <b style="font-size: medium">वैयक्तीक माहिती:</b>
            <asp:Label ID="personal_infoLabel" runat="server" 
                Text='<%# Bind("personal_info") %>' />
            <br />
            <b style="font-size: medium">करिअर:</b>
            <asp:Label ID="careerLabel" runat="server" Text='<%# Bind("career") %>' />
            <br />
            <b style="font-size: medium">पुरस्कार:</b>
            <asp:Label ID="awardsLabel" runat="server" Text='<%# Bind("awards") %>' />
            <br />
            <b style="font-size: medium">इतर माहिती:</b>
