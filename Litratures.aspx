<%@ Page Title="" Language="C#" MasterPageFile="~/pos.master" AutoEventWireup="true" CodeFile="Litratures.aspx.cs" Inherits="Litratures" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="Litrerature" Name="fields" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    </div>
</asp:Content>
