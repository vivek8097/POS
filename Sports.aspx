<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sports.aspx.cs" MasterPageFile="~/pos.master"  Inherits="Sports" %>
...
<div align="center">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="Sportsman" Name="fields" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    </div>
    </asp:Content>
