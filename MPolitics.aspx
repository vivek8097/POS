<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MPolitics.aspx.cs" MasterPageFile="~/mpos.master" Inherits="Politics" %>
...
<div align="center">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="राजकारण" Name="fields" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    </div>
</asp:Content>
