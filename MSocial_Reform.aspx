<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MSocial_Reform.aspx.cs" MasterPageFile="~/mpos.master" Inherits="Social_reform" %>
...
<div align="center">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="समाजसुधारक" Name="fields" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    </div>
    </asp:Content>
