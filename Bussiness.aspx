<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bussiness.aspx.cs" MasterPageFile="~/pos.master" Inherits="Bussiness" %>
...
<div align="center">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="Bussinessman" Name="fields" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    </div>
    </asp:Content>
