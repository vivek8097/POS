<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Politics.aspx.cs" MasterPageFile="~/pos.master" Inherits="Politics" %>
...
<div align="center">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="Politics" Name="fields" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    </div>
</asp:Content>
