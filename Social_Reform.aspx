<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Social_Reform.aspx.cs" MasterPageFile="~/pos.master" Inherits="Social_reform" %>
...
<div align="center">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="Social Reformer" Name="fields" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    </div>
    </asp:Content>
