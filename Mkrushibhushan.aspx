<%@ Page Title="" Language="C#" MasterPageFile="~/mpos.master" AutoEventWireup="true" CodeFile="Mkrushibhushan.aspx.cs" Inherits="Mkrushibhushan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="क्रुषिभूषण" Name="awards" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    </div>
</asp:Content>
