<%@ Page Title="" Language="C#" MasterPageFile="~/pos.master" AutoEventWireup="true" CodeFile="Kr.aspx.cs" Inherits="Kr" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="Krushiratna" Name="awards" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    </div>
</asp:Content>
