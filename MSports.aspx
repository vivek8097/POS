<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MSports.aspx.cs" MasterPageFile="~/mpos.master"  Inherits="Sports" %>
...
<div align="center">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="क्रीडा" Name="fields" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    </div>
    </asp:Content>
