<%@ Page Title="" Language="C#" MasterPageFile="~/pos.master" AutoEventWireup="true" CodeFile="Actors_Actress.aspx.cs" Inherits="Actors_Actress" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="Acter And Acteress" Name="fields" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    </div>
</asp:Content>
