<%@ Page Title="" Language="C#" MasterPageFile="~/mpos.master" AutoEventWireup="true" CodeFile="MAgree.aspx.cs" Inherits="MAgree" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="शेतीविषयक" Name="fields" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    </div>
</asp:Content>
